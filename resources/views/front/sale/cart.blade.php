						...
						<form method="post" action="#updatePost/">
							...
							<fieldset>
								<table class="data-table cart-table" id="shopping-cart-table">
									...
									<tbody>
									<tr class="first odd">
										<td class="image"><a class="product-image" title="Sample Product" href="http://ow.ly/XqzNo"><img width="75" alt="Sample Product" src="{{ url('products-images') }}/product1.jpg"></a></td>
									...
									<tr class="last even">
										<td class="image"><a class="product-image" title="Sample Product" href="#women-s-u-tank-top/"><img width="75" alt="Sample Product" src="{{ url('products-images') }}/product1.jpg"></a></td>
