...
@section('head')
	<title>{{$title or "Каталог сетка"}}</title>
@endsection
@section('content')
	<!-- breadcrumbs -->
						...
						<div class="slider-items-products">
							<div id="category-desc-slider" class="product-flexslider hidden-buttons">
								<div class="slider-items slider-width-col1">
									...
									<!-- Item -->
									<div class="item"> <a href="#x"><img alt="" src="{{ url('images') }}/category-banner1.jpg"></a>
									...
									<!-- Item -->
									<div class="item"> <a href="#x"><img alt="" src="{{ url('images') }}/women_banner1.png"></a> </div>
									<!-- End Item -->
