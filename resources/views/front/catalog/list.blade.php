...
@section('head')
	<title>{{$title or "Каталог список"}}</title>
@endsection
@section('content')
	<!-- breadcrumbs -->
			...
			<div class="row">
				<section class="col-main col-sm-9 col-sm-push-3 wow bounceInUp animated">
					<div class="category-description std">
						<div class="category-image"><img src="{{ url('images') }}/women_banner.png" alt="cat imges " title="Sofas "> </div>
					</div>
					...
					<div class="category-products">
						...
						<ol id="products-list" class="products-list">
							<li class="item odd">
								<div class="product-image"> <a href="#" title="HTC Rhyme Sense"> <img class="small-image" src="{{ url('products-images') }}/product1.jpg" alt="HTC Rhyme Sense" width="230"> </a> </div>
							...
							<li class="item even">
								<div class="product-image"> <a href="#microsoft-natural-ergonomic-keyboard-4000.html" title="Microsoft Natural Keyboard"> <img class="small-image" src="{{ url('products-images') }}/product1.jpg" alt="Microsoft Natural Keyboard" width="230"> </a> </div>
								<div class="product-shop">
									<h2 class="product-name"><a title=" Sample Product" href="http://ow.ly/XqzNo"> Sample Product </a></h2>
							...
							<li class="item odd">
								<div class="product-image"> <a href="#30-flat-panel-tft-lcd-cinema-hd-monitor.html" title="30&quot; Flat-Panel HD Monitor"> <img class="small-image" src="{{ url('products-images') }}/product1.jpg" alt="30&quot; Flat-Panel HD Monitor" width="230"> </a> </div>
								<div class="product-shop">
									<h2 class="product-name"><a title=" Sample Product" href="http://ow.ly/XqzNo"> Sample Product </a></h2>
							...
							<li class="item even">
								<div class="product-image"> <a href="#19-widescreen-flat-panel-lcd-monitor.html" title="19&quot; Widescreen LCD Monitor"> <img class="small-image" src="{{ url('products-images') }}/product1.jpg" alt="19&quot; Widescreen LCD Monitor" width="230"> </a> </div>
								<div class="product-shop">
									<h2 class="product-name"><a title=" Sample Product" href="http://ow.ly/XqzNo"> Sample Product </a></h2>
							...
							<li class="item odd">
								<div class="product-image"> <a href="#250gb-5400rpm.html" title="Seagate 250GB HD "> <img class="small-image" src="{{ url('products-images') }}/product1.jpg" alt="Seagate 250GB HD " width="230"> </a> </div>
								<div class="product-shop">
									<h2 class="product-name"><a title=" Sample Product" href="http://ow.ly/XqzNo"> Sample Product </a></h2>
							...
							<li class="item even">
								<div class="product-image"> <a href="#500gb-5400rpm.html" title="Seagate 500GB HD"> <img class="small-image" src="{{ url('products-images') }}/product1.jpg" alt="Seagate 500GB HD" width="230"> </a> </div>
								<div class="product-shop">
									<h2 class="product-name"><a title=" Sample Product" href="http://ow.ly/XqzNo"> Sample Product </a></h2>
							...
							<li class="item odd">
								<div class="product-image"> <a href="#intel-core-2-extreme-qx9775-3-20ghz-retail.html" title="Intel Core 2 Extreme QX9775"> <img class="small-image" src="{{ url('products-images') }}/product1.jpg" alt="Intel Core 2 Extreme QX9775" width="230"> </a> </div>
								<div class="product-shop">
									<h2 class="product-name"><a title=" Sample Product" href="http://ow.ly/XqzNo"> Sample Product </a></h2>
							...
							<li class="item even">
								<div class="product-image"> <a href="#24-widescreen-flat-panel-lcd-monitor.html" title="24&quot; Widescreen LCD Monitor"> <img class="small-image" src="{{ url('products-images') }}/product1.jpg" alt="24&quot; Widescreen LCD Monitor" width="230"> </a> </div>
								<div class="product-shop">
									<h2 class="product-name"><a title=" Sample Product" href="http://ow.ly/XqzNo"> Sample Product </a></h2>
							...
							<li class="item odd">
								<div class="product-image"> <a href="#microsoft-wireless-optical-mouse-5004.html" title="Logitech Optical Trackman"> <img class="small-image" src="{{ url('products-images') }}/product1.jpg" alt="Logitech Optical Trackman" width="230"> </a> </div>
								<div class="product-shop">
									<h2 class="product-name"><a title=" Sample Product" href="http://ow.ly/XqzNo"> Sample Product </a></h2>
							...
							<li class="item last even">
								<div class="product-image"> <a href="#" title="Logitech diNovo Edge Keyboard"> <img class="small-image" src="{{ url('products-images') }}/product1.jpg" alt="Logitech diNovo Edge Keyboard" width="230"> </a> </div>
								<div class="product-shop">
									<h2 class="product-name"><a title=" Sample Product" href="http://ow.ly/XqzNo"> Sample Product </a></h2>
				...
				<aside class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9 wow bounceInUp animated">
					...
					<div class="block block-cart">
						...
						<div class="block-content">
							...
							<ul>
								<li class="item"> <a class="product-image" title="Fisher-Price Bubble Mower" href="#"><img width="80" alt="Fisher-Price Bubble Mower" src="{{ url('products-images') }}/product1.jpg"></a>
								...
								<li class="item last"> <a class="product-image" title="Prince Lionheart Jumbo Toy Hammock" href="#"><img width="80" alt="Prince Lionheart Jumbo Toy Hammock" src="{{ url('products-images') }}/product1.jpg"></a>
									<div class="product-details">
										<div class="access"> <a class="btn-remove1" title="Remove This Item" href="#"> <span class="icon"></span> Remove </a> </div>
					...
					<div class="block block-banner"><a href="#"><img src="{{ url('images') }}/rhs-banner.jpg" alt="block-banner"></a></div>
				</aside>
			</div>
		</div>
	</div>
